...
class Tag extends \Spatie\Tags\Tag
{
    ...
    public function postsPublished(): MorphToMany
    {
        ...
        return $this->morphedByMany(SkyPlugin::get()->getModel('Post'), 'taggable')->published()->where("is_static",false);
    }

    public function links(): HasMany
    {
        // @phpstan-ignore-next-line
        return $this->hasMany(SkyPlugin::get()->getModel('Post'),'footer_tag_id','id')->where('status', 'publish')
