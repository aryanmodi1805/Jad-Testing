...
<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div class="fi-simple-layout flex  h-full flex-col items-center justify-center">
        ...
        <div
            ...
            <main
                @class([
                    'fi-simple-main my-0 w-full bg-white px-6 py-3 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 sm:rounded-xl sm:px-1',
                    match ($maxWidth ?? null) {
