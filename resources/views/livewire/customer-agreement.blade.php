<div class="relative min-h-screen bg-[#f9f9fa]">
    ...
    <div class="flex p-6 flex-col gap-20 items-center">
        <div class="container  p-12 bg-white overflow-hidden min-h-[40rem] z-10 mt-28">
            <h1 class="text-6xl text-center text-gray-800 font-bold leading-normal max-sm:!text-3xl">@lang('string.customer-agreement')</h1>
            <div class="container flex flex-col gap-4 pb-12 pt-28">
                {!!html_entity_decode( app(\App\Settings\CustomerAgreementSettings::class)->getCustomerAgreement(app()->getLocale()))!!}
            </div>
        </div>
