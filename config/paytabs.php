...
return [
    ...
    'profile_id' => env('paytabs_profile_id', 45243),
   ...
   */
    ...
    'server_key' => env('paytabs_server_key', 'SRJNMBTMKH-JJR29KMD9D-WLHHLBBJWR'),
...
//    'callback' => env('paytabs_ipn_callback',     new \App\Filament\Seller\Pages\SubscriptionPlans()),
