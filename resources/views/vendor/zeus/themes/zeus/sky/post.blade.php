<div class="container px-2 mx-auto mt-6 md:px-4">
    ...
    <x-slot name="breadcrumbs">
            ...
            <a href="{{ route('filament.guest.pages.blogs') }}"  class="text-gray-600 dark:text-gray-200 hover:text-blue-900 hover:underline focus:text-blue-900 focus:underline" >
                {{ __('Posts') }}
            </a>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-[2rem] rounded-tl-none shadow-md px-10 pb-6">
        ...
        <div class="mt-6 prose lg:mt-12 dark:prose-invert max-w-none break-normal">
            {!! $post->getContent() !!}
        </div>
    </div>
