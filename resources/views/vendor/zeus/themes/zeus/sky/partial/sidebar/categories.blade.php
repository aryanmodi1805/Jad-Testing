@unless($tags->isEmpty())
    <div class="my-4">
        <h4 class="mb-4 text-xl font-bold text-gray-700 dark:text-gray-200">{{__('Tags')}}</h4>
        <div class="flex flex-col max-w-sm px-4 py-6 mx-auto bg-white dark:bg-gray-800 rounded-[2rem] ltr:rounded-br-none rtl:rounded-bl-none shadow-md">
            <ul>
                @foreach($tags as $tag)
                    <li class="px-1 py-4 transition duration-300 border-t border-b border-white hover:border-primary-600">
