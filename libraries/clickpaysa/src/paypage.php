...
class paypage
{
    ...
    public function sendaAgreementDetails(array $agreement_data)
    {
        $this->clickpay_core->set04AgreementDetails($agreement_data);
         return $this;
    }
    ...
    {
        $this->clickpay_core->set99PluginInfo('Laravel',11,'1.3.3');
    ...
    public function refund($tran_ref,$order_id,$amount,$refund_reason)
    {
        ...
        if ($success) {
            ...
            throw  new Exception('some thing went wrong with integration' . $message);
        }
