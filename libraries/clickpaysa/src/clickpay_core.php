...
class ClickpayRequestHolder extends ClickpayHolder
{
    ...
    public function set04AgreementDetails($agreement_data = [])
    {
     ...
     */
    public function set10Tokenise($on = true, $token_format = 2, $optional = true)
    {
        if ($on) {
            $this->tokenise = [
