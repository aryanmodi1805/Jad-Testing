<div class="fixed top-0 left-0 h-screen w-screen z-50 bg-gray-950/50 dark:bg-gray-950/75 hidden j-main"
     x-data="{}"
     x-on:open-wizard.window="
             $nextTick(() => {
                $el.classList.remove('hidden');
            });"

     })
     x-on:request-location.window="setTimeout(() => {
