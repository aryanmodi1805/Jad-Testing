...
trait Configuration
{
     ...
     */
    protected Closure | string $skyPrefix = 'blog';
    ...
    protected bool $hasTagsResource = true;
    ...
    public function tagsResource(bool $condition = true): static
    {
        $this->hasTagsResource = $condition;
    ...
    public function hasTagsResource(): bool
    {
        return $this->hasTagsResource;
    }
