...
class HowItWorksCustomerSettings extends SettingsPage
{
    use HasPageShield;

    protected static ?string $navigationIcon = 'heroicon-o-cog-6-tooth';

    protected static string $settings = HowCustomerSettings::class;
    ...
    {
        return __('settings.how_it_works_settings.how_customer');
    }
            ...
            ->schema([
                Forms\Components\Section::make(__('settings.step_1'))
                    ->schema([
                        ...
                        Forms\Components\Textarea::make("step_1_description_en")->label(__('settings.step_description_en'))->nullable()->maxLength(150),
                        Forms\Components\Textarea::make("step_1_description_ar")->label(__('settings.step_description_ar'))->nullable()->maxLength(150),
                ...
                Forms\Components\Section::make(__('settings.step_2'))
                    ->schema([
                        ...
                        Forms\Components\Textarea::make("step_2_description_en")->label(__('settings.step_description_en'))->nullable()->maxLength(150),
                        Forms\Components\Textarea::make("step_2_description_ar")->label(__('settings.step_description_ar'))->nullable()->maxLength(150),
                ...
                Forms\Components\Section::make(__('settings.step_3'))
                    ->schema([
                        ...
                        Forms\Components\Textarea::make("step_3_description_en")->label(__('settings.step_description_en'))->nullable()->maxLength(150),
                        Forms\Components\Textarea::make("step_3_description_ar")->label(__('settings.step_description_ar'))->nullable()->maxLength(150),
                ...
                Forms\Components\Section::make(__('settings.step_4'))
                    ->schema([
                        ...
                        Forms\Components\Textarea::make("step_4_description_en")->label(__('settings.step_description_en'))->nullable()->maxLength(150),
                        Forms\Components\Textarea::make("step_4_description_ar")->label(__('settings.step_description_ar'))->nullable()->maxLength(150),
