...
@endphp
<div class="px-4 text-lg max-md:text-md">
<div class="w-full flex flex-col items-start gap-4 mb-4">
    <h5 class="font-bold text-lg">@lang('string.answers')</h5>
    ...
    @foreach($answers as $answer)
        ...
        <div class="mt-2 mb-8">
            ...
            @elseif($answer['question_type'] ==  QuestionType::Attachments && isset($answer['attachments']))
                <div class="">
                    @if(count($answer['attachments']) > 0)
