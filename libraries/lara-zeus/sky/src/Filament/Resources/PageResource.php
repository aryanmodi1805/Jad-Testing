            ...
            Tabs::make('post_tabs')->schema([
                ...
                Tabs\Tab::make(__('SEO'))->schema([
                    ...
                    Select::make('parent_id')
                        ->options(postStatus()->where('post_type', 'page')->pluck(
                            'title',
                            'id'
                        ))
                ...
                Tabs\Tab::make(__('Footer'))->schema([
                    Toggle::make('show_footer')
                        ->label(__('show_footer'))
                        ->default(0)
                        ->required()
                        ->live(),
                    ...
                    Select::make('footer_tag_id')->hidden(fn($get)=>$get('show_footer')==false)
                        ->label(__('footer_tag'))->required()
                        ->getOptionLabelFromRecordUsing(fn ($record) => "{$record->name}")->searchable()
                        ->options(Tag::where('type','footer')->pluck('name', 'id')),
                ]),
                Tabs\Tab::make(__('Header'))->schema([
                    Toggle::make('show_header')
                    ->label(__('show_header'))
                    ->default(0)
                    ->required(),
                ]),
