<section>
    <div class="container px-8 py-20 mx-auto">
        ...
        <div class="flex flex-col items-center w-full gap-6">
            ...
            <h3 class="text-5xl text-center font-bold max-sm:text-3xl w-full">@lang('blogs.latest_blog_posts')</h3>


            <div class="grid items-center grid-cols-3 w-full gap-6 py-12 max-xl:grid-cols-2 max-md:grid-cols-1">
