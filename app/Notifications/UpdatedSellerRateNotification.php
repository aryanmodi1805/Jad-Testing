...
class UpdatedSellerRateNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function via(Seller $notifiable): array
    {
        ...
        $this->action_label = __('notification.updated_seller_rate.action', locale: $this->locale);

        $this->title = __('notification.updated_seller_rate.title', locale: $this->locale);

        $this->body = __('notification.updated_seller_rate.body', [
    ...
    public function toDatabase(object $notifiable): array
    {
        return FilamentNotification::make()
            ...
            ->actions(fn() => $this->action != null ?[
                Action::make(__('notification.updated_seller_rate.action' ,locale: $this->locale))
                    ->url( $this->action)
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage())
            ...
            ->greeting(__('notification.updated_seller_rate.greeting', ['name' => $notifiable->name] , locale: $this->locale))
            ->line($this->body)
